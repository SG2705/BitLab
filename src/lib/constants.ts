...
// ── Gate labels (derived from engine's LB_MAP — single source of truth) ──────
// LB_MAP maps gate type → message key. We derive the UI-facing label map
...
export const MESSAGES = defineMessages({
  ...
  lb_not_2: { id: "NUpvef", defaultMessage: "NOT-2" },
  lb_not_4: { id: "nbKKlV", defaultMessage: "NOT-4" },
  lb_not_8: { id: "j7tPqv", defaultMessage: "NOT-8" },
  lb_buffer: { id: "k5fiSA", defaultMessage: "Buffer" },
  lb_and_3: { id: "uPTSs/", defaultMessage: "AND-3" },
  lb_and_4: { id: "uRp42B", defaultMessage: "AND-4" },
  lb_and_8: { id: "8ayZOL", defaultMessage: "AND-8" },
  lb_and_16: { id: "XtlH6z", defaultMessage: "AND-16" },
  lb_or_3: { id: "kjUTRa", defaultMessage: "OR-3" },
  lb_or_4: { id: "8IFOIz", defaultMessage: "OR-4" },
  lb_or_8: { id: "rWbVdz", defaultMessage: "OR-8" },
  lb_or_16: { id: "7OjQqz", defaultMessage: "OR-16" },
  ...
  lb_bus_input16: { id: "1Yb46k", defaultMessage: "Bus In 16" },
  lb_bus_and4: { id: "9u25Hp", defaultMessage: "Bus AND 4" },
  lb_bus_and8: { id: "m6pj/i", defaultMessage: "Bus AND 8" },
  lb_bus_and16: { id: "1k5b21", defaultMessage: "Bus AND 16" },
  lb_bus_or4: { id: "0F5oKT", defaultMessage: "Bus OR 4" },
  lb_bus_or8: { id: "c0zYiQ", defaultMessage: "Bus OR 8" },
  lb_bus_or16: { id: "ss8U3M", defaultMessage: "Bus OR 16" },
  lb_bus_not4: { id: "rvUikf", defaultMessage: "Bus NOT 4" },
  lb_bus_not8: { id: "p782Q2", defaultMessage: "Bus NOT 8" },
...
export const GATE_TYPE_LABELS: Record<
  ...
  { en: string; messageKey: Messages }
> = Object.fromEntries(
  Object.entries(LB_MAP)
    .filter(([, msgKey]) => msgKey in MESSAGES)
    .map(([type, msgKey]) => [
      type,
      {
        en: MESSAGES[msgKey as Messages].defaultMessage,
        messageKey: msgKey as Messages,
      },
    ]),
);
